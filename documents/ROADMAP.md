...
- ✅ **Lernen (D) sauber von der Tonalität trennen** — beim Übernehmen wird jetzt **immer die EmpCo-konforme Basis** (`text`) als Trainingsbeispiel gelernt, auch wenn die Brand-Voice-Fassung (`tov_text`) übernommen wird (`variant`-Feld steuert das). So bleibt der Umformulierungs-Redakteur frei von tonaler Prägung. UI: Buttons „✓ Übernehmen &amp; lernen" / Tooltip machen transparent, dass Akzeptieren ins KI-Training geht.
