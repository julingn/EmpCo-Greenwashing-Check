    ...
    <?php foreach ($findings as $f): ?>
      <div class="card" style="padding:16px 20px">
        <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap">
          <span class="badge <?= h($f['severity']) ?>"><?= h($sevLabel[$f['severity']] ?? $f['severity']) ?></span>
        ...
        <blockquote style="margin:12px 0 8px;padding:10px 14px;border-left:3px solid var(--red-border);background:var(--red-bg);border-radius:6px;color:var(--text)">
          „<?= h($f['snippet']) ?>"
        </blockquote>
